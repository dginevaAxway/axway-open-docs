...
API Portal requires PHP 7.1 or later. (Support for PHP 7.4 was introduced in version 7.7.20200130. We strongly recommend to use only officially supported PHP Versions, for more info [visit this page](https://www.php.net/supported-versions.php).)
