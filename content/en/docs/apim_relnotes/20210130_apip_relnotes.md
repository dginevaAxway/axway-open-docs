...
| IAP-3876        |             |                    | **Issue**: `openssl` security issue `EDIPARTYNAME NULL` pointer de-reference (CVE-2020-1971). **Resolution**: Update released by RHERL. See [here] (https://access.redhat.com/articles/11258) for details on how to apply this update.                                                                                                    |
